      ...
      <div className="container">
        ...
        <div className="heritage-magazine-grid">
          ...
          <div className="heritage-narrative-block">
            ...
            {/* 4 Pillars of Ancestral Purity with Roman Numerals */}
            <div className="heritage-tenets-grid">
              <div className="heritage-tenet-item">
                <span className="tenet-num">I</span>
                <div>
                  <h4>Stone-Ground at 28 RPM</h4>
                  <p>Slow granite milling protects live phytocompounds and natural aroma.</p>
                </div>
              </div>
              ...
              <div className="heritage-tenet-item">
                ...
                <div>
                  <h4>Earthen Pot Gentle Roasting</h4>
                  <p>Heirloom lentils slow-toasted in clay vessels to avoid scorching.</p>
                </div>
              </div>
              ...
              <div className="heritage-tenet-item">
                ...
                <div>
                  <h4>Ancestral Siddha Formulations</h4>
                  <p>Therapeutic herbs like Pirandai blended in time-tested balanced ratios.</p>
                </div>
              </div>
              ...
              <div className="heritage-tenet-item">
                ...
                <div>
                  <h4>Zero Additives & Airtight Jars</h4>
                  <p>Never any MSG, preservatives, or anti-caking agents. Freshly packed.</p>
                </div>
              </div>
            </div>
          </div>
